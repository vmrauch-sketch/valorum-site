          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8">
                Com nosso serviço de CFO Terceirizado, você conta com um direcionamento financeiro especializado que aplica nossa metodologia na sua empresa, trazendo a visão estratégica que você precisa para impulsionar seus resultados.
              </p>
