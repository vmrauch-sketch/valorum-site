  ...
  const processSteps = [
    {
      ...
      icon: Lightbulb,
      description:
        "Analisamos sua situação atual, objetivos e perfil de risco para criar a base do seu planejamento.",
    },
    {
      title: "Definir",
      ...
      icon: Target,
      description:
        "Estruturamos estratégias personalizadas alinhadas aos seus objetivos e horizonte de investimento.",
    },
    {
      title: "Implementar",
